			...
			return {
				...
				mustDoLists:[
					...
					},
					{
						...
						endDate: "14:00",
						mustDoNum:"3",
						mustDoText:"添加计划--->自动合并时间重合的部分，判断时间的大小，.",
						current: 0,
						color: "",
						selectColor: "",
						img: [],
					},
					{
						...
						endDate: "16:00",
						mustDoNum:"4",
						mustDoText:"时间段转化的时候，下一个时间段变红，上一个时间段不改变颜色。",
						current: 0,
						color: "",
						selectColor: "",
						img: [],
					},
					{
						...
						endDate: "18:00",
						mustDoNum:"4",
						mustDoText:"每次觉得写东西，都在写html和css，很少写js，怎么回事。",
						current: 0,
						color: "",
						selectColor: "",
						img: [],
					},
					{
						...
						endDate: "20:00",
						mustDoNum:"4",
						mustDoText:"proxy具体用法，里边的get，set怎么用。	",
						current: 0,
						color: "",
						selectColor: "",
						img: [],
